...
body {
        ...
        .navbar.sticky {
            ...
            background-color: #cc2ff3; /* Optional: Customize background color */
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm fixed-top" style="background-color: #ba41f1;color:white">
            <div class="container"> 
            ...
            <ul class="navbar-nav mx-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" style="color:white" href="#" id="karyawanDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" style="color:white" href="#" id="presensiDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" style="color: white"  href="#" id="cutiDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <footer class=" text-white text-center py-3 fixed-bottom " style="background-color:#ba41f1" >
            <div class="container">
