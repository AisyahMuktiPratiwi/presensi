...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light  shadow-sm fixed-top" style="background-color:#4675f7">
            <div class="container">
                <a class="navbar-brand mr-auto" href="{{ url('/') }}" style="color:white">
...
<br>
<br>
        <footer class="text-white text-center py-3 fixed-bottom mt-2" style="background-color:#4675f7;">
            <div class="container">
