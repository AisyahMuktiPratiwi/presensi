...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color:#af74fcfb;color:white">Edit Data Lembur</div>
                    ...
                    <div class="card-body" style="background-color: #e8d7ff">
                        ...
                        <form method="POST" action="{{ route('admin.lembur.update', $lembur->id) }}">
                            ...
                            <button type="submit" class="btn btn" style="background-color:#af74fcfb;color:white ">Simpan Perubahan</button>
                        </form>
