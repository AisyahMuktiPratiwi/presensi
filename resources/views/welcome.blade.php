        ...
        <div class="welcome-card">
            ...
            <div class="welcome-links">
                @if (Route::has('login'))
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn btn" style="background-color: #7f5ae6fb">Log in</a>
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn" style="background-color: #4675f7">Register</a>
                        @endif
                    @endauth
                @endif
            </div>
