...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header" style="background-color: #ac6bfa;color:white">Riwayat lembur Lembur</div>
                                ...
                                <tbody>
                                    ...
                                    @if($lemburs->karyawan->user_id == Auth::id())
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-info {{ $presensiController->getStatusColorClass($lemburs->status) }}">
